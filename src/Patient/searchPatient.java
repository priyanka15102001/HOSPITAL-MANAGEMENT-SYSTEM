...
public class searchPatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(161, 123, -1, -1));
        ...
        getContentPane().add(pSearchField, new org.netbeans.lib.awtextra.AbsoluteConstraints(428, 127, 500, 40));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(955, 116, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 1263, 406));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Patient/dxjKpR[1]_1.jpg"))); // NOI18N
        jLabel3.setText("jLabel3");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1260, 580));
