...
public class deleteReceptionist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(rDeleteField, new org.netbeans.lib.awtextra.AbsoluteConstraints(559, 127, 500, 40));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1086, 116, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Receptionists/dxjKpR[1].jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1290, 610));
