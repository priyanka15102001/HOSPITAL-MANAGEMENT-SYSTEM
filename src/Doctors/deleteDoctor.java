...
public class deleteDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(dDeleteField, new org.netbeans.lib.awtextra.AbsoluteConstraints(472, 127, 500, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 1289, 438));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(999, 116, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Doctors/dxjKpR[1].jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1290, 620));
